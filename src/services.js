const services = [
    {
        ...
        describe: 'Dental cleanings involve removing plaque (soft, sticky, bacteria infested film) and tartar (calculus) deposits that have built up on the teeth over time. Your teeth are continually bathed in saliva which contains calcium and other substances which help strengthen and protect the teeth. While this is a good thing, it also means that we tend to get a build-up of calcium deposits on the teeth. This chalky substance will eventually build up over time, like limescale in a pipe or kettle. Usually it is tooth coloured and can easily be mistaken as part of the teeth, but it also can vary from brown to black in colour.',
        fee: 'TK 1000',
        image: 'http://www.japandentalbd.com/images/Scaling2.jpg'
    },
    {
        id: 2,
        name: 'Minimally Invasive Cosmetic Filling',
        describe: 'Minimally invasive cosmetic procedures include (but are not limited to) treatments with non-ablative lasers, radio frequency, acoustic waves, cosmetic tattooing, light-based therapies, light-to-medium strength chemical peels, and even surgical treatments which can be performed under only local anesthetic. Since the introduction of the Medi-Spa, these procedures are growing more and more accessible to the average person looking to improve his or her appearance.',
        fee: 'TK 1500',
        image: 'http://www.japandentalbd.com/images/cosmetic.jpg'
    },
    {
        id: 3,
